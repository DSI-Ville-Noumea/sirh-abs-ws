...
privileged aspect DroitsAgent_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> DroitsAgent.fieldNames4OrderClauseFilter = java.util.Arrays.asList("idDroitsAgent", "idAgent", "codeService", "libelleService", "dateModification", "droitDroitsAgent");
