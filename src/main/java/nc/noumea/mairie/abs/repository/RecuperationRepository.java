...
public class RecuperationRepository implements IRecuperationRepository {
	...
	@Override
	public List<AgentWeekRecup> getListeAlimAutoRecupByAgent(Integer convertedIdAgent) {

		TypedQuery<AgentWeekRecup> query = absEntityManager.createNamedQuery("findAgentWeekRecupByIdAgent",
				AgentWeekRecup.class);
