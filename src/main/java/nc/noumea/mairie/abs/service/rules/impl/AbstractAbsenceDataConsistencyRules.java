...
public abstract class AbstractAbsenceDataConsistencyRules implements IAbsenceDataConsistencyRules {
	...
	public static final String					DEMANDE_DATE_FUTUR_KIOSQUE_MSG			= "La date de début ne peut pas être dans le futur.";
	public static final String					DEMANDE_DATE_FUTUR_SIRH_MSG				= "La date de début ne peut pas être saisie plus de 2 mois dans le futur.";
