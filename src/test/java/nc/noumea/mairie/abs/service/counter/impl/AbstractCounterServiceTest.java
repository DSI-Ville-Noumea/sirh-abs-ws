...
public class AbstractCounterServiceTest {
	...
	public void majAgentHistoAlimManuelle() {
		...
		service.majAgentHistoAlimManuelle(idAgentOperateur, idAgentConcerne, motifCompteur, textLog, compteurAgent, idRefTypeAbsence);
	...
	public void majManuelleCompteurToAgent_prepareData() {
		...
		Mockito.when(counterRepository.getEntity(MotifCompteur.class, 1)).thenReturn(
				new MotifCompteur());
	}
}
