...
import nc.noumea.mairie.abs.asa.service.counter.impl.AsaA54CounterServiceImpl;
...
public class AsaA54CounterServiceImplTest extends AsaCounterServiceImplTest {
	...
	public void getListeCompteur_noResult() {
		...
		ICounterRepository counterRepository = Mockito.mock(ICounterRepository.class);
		Mockito.when(counterRepository.getListCounter(AgentAsaA54Count.class)).thenReturn(
				new ArrayList<AgentAsaA54Count>());
	...
	public void getListeCompteur_1Result() {
		...
		ICounterRepository counterRepository = Mockito.mock(ICounterRepository.class);
		Mockito.when(counterRepository.getListCounter(AgentAsaA54Count.class)).thenReturn(list);
	...
	public void majCompteurAsaA54ToAgent_compteurNegatif_debit() {
		...
		Mockito.when(rr.getAgentCounter(AgentAsaA54Count.class, demande.getIdAgent())).thenReturn(arc);
