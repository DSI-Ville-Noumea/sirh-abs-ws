...
import nc.noumea.mairie.abs.asa.service.rules.impl.AbsAsaA53DataConsistencyRulesImpl;
...
public class AbsAsaA53DataConsistencyRulesImplTest extends AbsAsaDataConsistencyRulesImplTest {
	...
	public void checkDroitCompteurAsaA53_aucunDroit() {
		...
		Mockito.when(counterRepository.getOSCounterByDate(AgentAsaA53Count.class, demande.getOrganisationSyndicale().getIdOrganisationSyndicale(), dateDebut)).thenReturn(
				soldeAsaA53);
