...
public class AbsReposCompensateurDataConsistencyRulesImplTest {
	...
	@Test
	public void checkChampMotifPourEtatDonne_motifVide_Refusee() {
	...
	public void filtreDateAndEtatDemandeFromList_EtatAndDateDemandeFilter_NoResult_BadEtat() {
		...
		refType.setIdRefTypeAbsence(2);
		refType.setLabel("REPOS_COMP");
		EtatDemande etat1 = new EtatDemande();
		...
		d.setDuree(30);
		DemandeReposComp d2 = new DemandeReposComp();
		etat2.setDemande(d2);
		d2.setIdDemande(2);
		d2.setType(refType);
	...
	public void filtreDateAndEtatDemandeFromList_DemandesEnCours_4results() {
		...
		DemandeReposComp d3 = new DemandeReposComp();
		etat3.setDemande(d3);
		d3.setIdDemande(3);
		...
		DemandeReposComp d4 = new DemandeReposComp();
		etat4.setDemande(d4);
		d4.setIdDemande(4);
		...
		DemandeReposComp d5 = new DemandeReposComp();
		etat5.setDemande(d5);
		d5.setIdDemande(5);
		...
		DemandeReposComp d6 = new DemandeReposComp();
		etat6.setDemande(d6);
		d6.setIdDemande(6);
		...
		DemandeReposComp d7 = new DemandeReposComp();
		etat7.setDemande(d7);
		d7.setIdDemande(7);
		...
		DemandeReposComp d8 = new DemandeReposComp();
		etat8.setDemande(d8);
		d8.setIdDemande(8);
	...
	public void filtreDroitOfListeDemandesByDemande_DemandeOfAgent() {
		...
		// When
		List<DemandeDto> result = service.filtreDroitOfListeDemandesByDemande(idAgentConnecte, idAgentConcerne,
				resultListDto);
